"""
Ceci est la présentation des règles avant de commencer le jeu:
Tout d'abord vous allez devoir créer deux équipes composé de 1 à 3 personnes.
Ensuite viendront les épreuves, il y en a 4 types différentes:
o Mathématiques (calculs de factorielles, équations, roulettes mathématiques)
